...
If **Fast Refresh** is not working, try switching to file watch polling using the [`watchOptions.pollIntervalMs`](/docs/app/api-reference/config/next-config-js/watchOptions) option.
