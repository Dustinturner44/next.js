...
export function DynamicPanel({
  ...
  // Panel is never docked in simplified mode
  ...
  // Panel should be visible if it's active or if a non-modal panel is active
  ...
  // No docking position in simplified mode
  const dockPosition = null
