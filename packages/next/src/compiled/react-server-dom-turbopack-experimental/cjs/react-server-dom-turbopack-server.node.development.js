          ...
          init: function (asyncId, type, triggerAsyncId, resource) {
            ...
            if ("PROMISE" === type)
              if (
                ...
                triggerAsyncId = null;
                var triggerPromiseRef = trigger.promise;
                null !== triggerPromiseRef &&
                  ((triggerPromiseRef = triggerPromiseRef.deref()),
                  void 0 !== triggerPromiseRef &&
                    (triggerAsyncId = triggerPromiseRef));
                type = pendingOperations.get(type);
                void 0 !== type &&
                  ((triggerPromiseRef = type.promise),
                  null !== triggerPromiseRef &&
                    ((triggerPromiseRef = triggerPromiseRef.deref()),
                    void 0 !== triggerPromiseRef &&
                      (triggerAsyncId =
                        null === triggerAsyncId
                          ...
                          : [triggerAsyncId, triggerPromiseRef])));
                null !== triggerAsyncId &&
                  awaitedPromise.set(resource, triggerAsyncId);
                triggerAsyncId = null;
                null === trigger.stack ||
                (2 !== trigger.tag && 4 !== trigger.tag)
                  ? ((resource = new WeakRef(resource)),
                    (triggerPromiseRef = resolveRequest()),
                    null !== triggerPromiseRef &&
                      ((triggerAsyncId = parseStackTracePrivate(Error(), 5)),
                      null === triggerAsyncId ||
                        isAwaitInUserspace(triggerPromiseRef, triggerAsyncId) ||
                        (triggerAsyncId = null)))
